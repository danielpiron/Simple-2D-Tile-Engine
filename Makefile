...
render: main.o sdlrender.o animation.o tilemap.o
	$(CXX) $(CXX_FLAGS) $(LD_FLAGS) -o render sdlrender.o main.o animation.o tilemap.o -lSDL2 -lSDL2_image
...
tilemap.o: tilemap.cpp
	$(CXX) $(CXX_FLAGS) -o tilemap.o -c tilemap.cpp
